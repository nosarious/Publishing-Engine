...
$resolutions   = array(1382, 1024, 992, 768, 480); // the resolution break-points to use (screen widths, in pixels)
...
$browser_cache = 60*60*24*365; // How long the BROWSER cache should last (seconds, minutes, hours, days. 7days by default)
